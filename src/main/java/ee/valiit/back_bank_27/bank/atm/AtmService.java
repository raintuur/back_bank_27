...
@Service    //Teeb objekti, mida saab igal pool kasutada.
public class AtmService {
    ...
    public List<AtmLocationDto> getAtmLocations(Integer cityId) {
        ...
        for (AtmLocationDto locationDto : locationDtos) {
            List<LocationTransaction> locationTransactions = locationTransactionService.findByLocationTransactions(locationDto.getLocationId(), true);
